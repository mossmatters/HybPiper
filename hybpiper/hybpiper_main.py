...
'hybpiper -h' or 'hybpiper --help'. They are:
    ...
    retrieve_sequences  Retrieve sequences generated by the HybPiper run(s)
    recovery_heatmap    Create a gene recovery heatmap for the HybPiper runs
    paralog_retriever   Retrieve paralog sequences generated by the HybPiper run(s)
...
def check_targetfile(args):
    """
    Performs target file checks. Does not translate a DNA file; low-complexity checks are performed on the
    target file as provided.

    :param args: argparse namespace with subparser options for function utils.check_targetfile()
    :return: None: no return value specified; default is None
    """
